...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      description="Ev yapımı tatlılarımız ve özenle hazırlanan kahvelerimizle Holââ Coffee House'da sizi evinizde hissettiriyoruz. İşletme hattımıza 0546 722 14 01 numarasından ulaşabilirsiniz."
      buttons={[
        {
          text: "Menümüzü Keşfet",          href: "#products"},
      ]}
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/portrait-smiling-asian-girl-barista-giving-out-order-cafe-inviting-guest-pick-up-takeaway_1258-199328.jpg",          alt: "Happy customer 1"},
        {
          src: "http://img.b2bpic.net/free-photo/waitress-serving-cup-coffee-customers_1170-652.jpg",          alt: "Happy customer 2"},
        {
          src: "http://img.b2bpic.net/free-photo/enthusiastic-young-asian-woman-barista-apron-looking-amazed-clap-hands-smiling-standing-co_1258-148443.jpg",          alt: "Happy customer 3"},
        {
          src: "http://img.b2bpic.net/free-photo/cafe-small-business-smiling-asian-barista-apron-standing-counter-coffee-shop-workin_1258-138357.jpg",          alt: "Happy customer 4"},
        {
          src: "http://img.b2bpic.net/free-photo/outdoor-portrait-smiling-attractive-young-woman-with-short-curly-dark-hair-red-lips_291650-524.jpg",          alt: "Happy customer 5"},
      ]}
      avatarText="1000+ Mutlu Misafir"
      marqueeItems={[
        {
          type: "text",          text: "Taze Çekirdek"},
        {
          type: "text-icon",          text: "Organik Tatlar",          icon: Leaf,
        },
        {
          type: "text",          text: "Ev Yapımı"},
        {
          type: "text-icon",          text: "Hızlı Servis",          icon: Coffee,
        },
        {
          type: "text",          text: "Özel Harman"},
      ]}
    />
  </div>
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          id: "1",          title: "Ev Yapımı Tatlılar",          descriptions: [
        ...
        {
          id: "2",          title: "Sıcak Atmosfer",          descriptions: [
        ...
        {
          id: "3",          title: "Güler Yüzlü Hizmet",          descriptions: [
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        {
          id: "m2",          icon: Award,
          title: "El Yapımı Lezzet",          value: "15+"},
        {
          id: "m3",          icon: Star,
          title: "Tam Puan",          value: "98%"},
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",          title: "Tuvalet var mı?",          content: "Evet, alt katımızda misafirlerimize özel lavabomuz mevcuttur."},
        {
          id: "q2",          title: "Ders çalışmaya uygun mu?",          content: "Çok sayıda prizimiz ve yüksek hızlı WiFi bağlantımızla ders çalışmak için idealdir."},
        {
          id: "q3",          title: "Rezervasyon yapılıyor mu?",          content: "Genelde butik bir kafe olduğumuz için gelmeden aramanızı öneririz."},
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      background={{
        variant: "gradient-bars"}}
      text="Sizi ağırlamaktan mutluluk duyarız. 0546 722 14 01 numarasından bize ulaşın, bir kahveye bekliyoruz!"
    />
  </div>
